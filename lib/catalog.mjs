...
export function loadCatalog(root = process.cwd()) {
  ...
  return {
    ...
    // The side definitions live beside the models, and every consumer — ctsx, resolve, the
    // registry projection — reads this one source rather than re-opening the taxonomy.
    sides: models.sides ?? {},
