...
// are the question titles — the same problem as before: the export carries the LABEL, never the
// field id, and our labels are industry-interpolated ("...your Grocery & q-commerce experience?").
// `collector/forms/form-map-<industry>-v<n>.json` is what maps a header back to a field id, and
// old versions are kept so a response filed against an earlier form still maps.
//
 ...
 *          max_length:number|null,required:boolean}[]}} map form map for this industry
