...
# Add grocery B2B2C: Utility & system pages

## Why

The grocery vertical requires behaviour a bare B2B2C storefront does not have. This change introduces the utility & system pages capabilities for it.
