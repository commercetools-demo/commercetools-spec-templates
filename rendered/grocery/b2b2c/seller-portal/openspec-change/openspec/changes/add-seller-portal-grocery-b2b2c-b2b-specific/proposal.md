...
# Add grocery B2B2C: B2B-specific pages

## Why

The grocery vertical requires behaviour a bare B2B2C storefront does not have. This change introduces the b2b-specific pages capabilities for it.
