...
| Slot capacity scoped to the fulfilling seller | `[MIDDLEWARE]` | One capacity ledger per seller Channel |
...
_Excluded for B2B2C: Recurring slot for a standing order._
