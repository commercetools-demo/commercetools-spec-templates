...
# Add grocery B2C: User journeys

## Why

The grocery vertical requires behaviour a bare B2C storefront does not have. This change introduces the user journeys capabilities for it.
