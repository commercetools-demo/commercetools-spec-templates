...
# Add grocery B2C: Basket & pricing

## Why

The grocery vertical requires behaviour a bare B2C storefront does not have. This change introduces the basket & pricing capabilities for it.
