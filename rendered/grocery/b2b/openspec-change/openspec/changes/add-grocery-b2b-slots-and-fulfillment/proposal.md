...
# Add grocery B2B: Slots & fulfillment

## Why

The grocery vertical requires behaviour a bare B2B storefront does not have. This change introduces the slots & fulfillment capabilities for it.
