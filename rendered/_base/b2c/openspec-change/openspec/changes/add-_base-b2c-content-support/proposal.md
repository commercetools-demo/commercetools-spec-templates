...
# Add _base B2C: Content & support pages

## Why

The _base vertical requires behaviour a bare B2C storefront does not have. This change introduces the content & support pages capabilities for it.
