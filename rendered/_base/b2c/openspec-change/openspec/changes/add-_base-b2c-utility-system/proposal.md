...
# Add _base B2C: Utility & system pages

## Why

The _base vertical requires behaviour a bare B2C storefront does not have. This change introduces the utility & system pages capabilities for it.
