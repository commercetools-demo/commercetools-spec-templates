...
# Add _base B2B2C: User journeys

## Why

The _base vertical requires behaviour a bare B2B2C storefront does not have. This change introduces the user journeys capabilities for it.
