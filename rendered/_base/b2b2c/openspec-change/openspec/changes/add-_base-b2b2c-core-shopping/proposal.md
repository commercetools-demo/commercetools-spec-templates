# Add _base B2B2C: Core shopping pages

## Why

The _base vertical requires behaviour a bare B2B2C storefront does not have. This change introduces the core shopping pages capabilities for it.
