...
# Add _base B2B: Account & self-service pages

## Why

The _base vertical requires behaviour a bare B2B storefront does not have. This change introduces the account & self-service pages capabilities for it.
