...
# Add _base B2B: User journeys (part 1 of 2)

## Why

The _base vertical requires behaviour a bare B2B storefront does not have. This change introduces the user journeys (part 1 of 2) capabilities for it.
