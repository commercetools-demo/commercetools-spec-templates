...
# Add _base B2B: B2B-specific pages

## Why

The _base vertical requires behaviour a bare B2B storefront does not have. This change introduces the b2b-specific pages capabilities for it.
