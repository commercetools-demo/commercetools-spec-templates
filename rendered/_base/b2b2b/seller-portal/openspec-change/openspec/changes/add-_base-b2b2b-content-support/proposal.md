...
# Add _base B2B2B: Content & support pages

## Why

The _base vertical requires behaviour a bare B2B2B storefront does not have. This change introduces the content & support pages capabilities for it.
