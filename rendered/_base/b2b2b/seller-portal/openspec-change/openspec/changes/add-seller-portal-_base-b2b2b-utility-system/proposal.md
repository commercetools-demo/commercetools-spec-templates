...
# Add _base B2B2B: Utility & system pages

## Why

The _base vertical requires behaviour a bare B2B2B storefront does not have. This change introduces the utility & system pages capabilities for it.
