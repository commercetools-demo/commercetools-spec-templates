...
# Add _base B2B2B: Core shopping pages

## Why

The _base vertical requires behaviour a bare B2B2B storefront does not have. This change introduces the core shopping pages capabilities for it.
